// src/components/02-molecules/HorarioMateria.tsx

import React from 'react';

export default function HorarioFicha() {
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="flex justify-start items-center mb-4">
        <span className="text-sm font-medium">Ficha (Materia): Asistencia Para Inteligencia Empresarial 2929143</span>
      </div>
